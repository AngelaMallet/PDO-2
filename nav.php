...
<div class="navbar-fixed">
    ...
    <nav>
        <div class="nav-wrapper red accent-1">
            <ul class="right">
                <li><a href="index.php" class="white-text text-red accent-1 oval hide-on-med-and-down"><svg width="150px" height="150px" viewBox="0 0 1000 1000">
        ...
        <rect x="0" y="0" width="500" height="500" filter="url(#blendit)"/>
                ...
                <li><a href="liste-patients.php" class="white-text text-red accent-1">Liste des patients</a></li>
                <li><a href="ajout-rendezvous.php" class="white-text text-red accent-1">Prendre rendez-vous</a></li>
                <li><a href="liste-rendez-vous.php" class="white-text text-red accent-1">Liste des rendez-vous</a></li>
                <li class="active"><li><a href="ajout-patient.php" class="white-text text-red accent-1">Inscription<i class="tiny material-icons">add_circle</i></a></li>
                <li><a href="<a href="profil-patient.php?id=<?= $patientsList->id ?>" class="white-text text-red accent-1">Profil<i class="tiny material-icons">account_circle</i></a></li>
            </ul>
        </div>
    </nav>
</div>